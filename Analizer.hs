...
exp ((Operator CAR):b)      = do													     --CAR EXP
                                ...
                                Return (result, ( CARC  trad))						--creazione monade
...
{-
	...
	La funzione Bind viene richiamata continuamente fino a quando non inizia a effettuare un ritorno.
...
funt a = do
           ...
           funt1 x trad_funt		          --richiamo T1 passando la traduzione di F (attributi che T1 eredita)

{-  FUNZIONE E1
	6 E1_a::= OPA T E1_b | epsilon
	La funzione viene richiamata ereditanto il primo operando. Essa deve tradurre il secondo operando indipendentemente dal simbolo "+" o "-".
...
{-
	...
	La fuzione ritorna una lista di LKC poiche' sarebbero i parametri di funzione
