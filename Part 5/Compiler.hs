...
{-	FUNZIONE COMPLIST:
   ...
   -- cons è l'istruzione SECD che concatena una lista Può essere che un parametro attuale sia una definzione lambda 
...
comp e n c =  case e of
        ...
        LAMBADC x y:
          ...
          -- COMP produce codice SECD corrispondente al corpo body usando un ambiente statico n a cui 
             ...
             quando il corpo della funzione è compilato.
          ...
          -- Allora, B sarà parametro di un'istruzione Ldf la quale, quando
             verrà eseguita, caricherà B sullo stack S, costruendo, allo stesso tempo, la
             chiusura (B,E), dove E è l’ambiente dinamico al momento dell’esecuzione di
             Ldf, cioè al momento della definizione della funzione stessa. Questo ambiente
        ...
        -- preparo parametri formali 
        -- l'ambiente resta n e c diventa la chiusura della let
        -- LETC LKC[(LKC,LKC)]
        ...
        (LETC x y) -> let e = exprs (y)
                      ...
                      {- LETC x y:
                        ...
                        -- uso AP per caricare il corpo della funzione sul controllo 
                        -- e costruire l'ambiente in cui fare l'esecuzione
                        ...
                        -- Infatti una LETC introduce binders della forma x=exp, in
                           ...
                           D’altra parte i valori delle variabili locali, cioè i valori dei 
                           ...
                           una Ap farà eseguire il corpo del LETC nell’ambiente dinamico corretto 
